...
public:
    BankAccount(const std::string& first_name, const std::string& last_name, double initial_balance)
        ...
        // Création d'un fichier texte pour chaque compte dans le répertoire "ges_compte_bank"
        fs::create_directory("ges_compte_bank");
        std::ofstream account_file("ges_compte_bank/" + getFileName());
...
private:
    ...
    std::string getFileName() const {
        return last_name + "_" + first_name + ".txt";
    }
};
